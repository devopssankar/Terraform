...
metrics = {"CPUUtilization":{"type":"float", "value":None},
    ...
    "Deadlocks":{"type":"int", "value":None},
    "EngineUptime":{"type":"int", "value":None},
    ...
    "AuroraReplicaLag":{"type":"int", "value":None},
...
if options.metric in metrics.keys():
  ...
  if (k == "FreeStorageSpace" or k == "FreeableMemory" or k == "FreeLocalStorage"):
